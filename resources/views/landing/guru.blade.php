...
<head>
    ...
    <title>Portal Guru — SIK Rumah Sehat Binatama</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .bg-overlay { position:fixed; inset:0; background:linear-gradient(135deg,rgba(21,101,192,0.55) 0%,rgba(25,118,210,0.50) 50%,rgba(66,165,245,0.45) 100%); z-index:1; }
        ...
        .hero-card { background:rgba(10,45,110,0.60); backdrop-filter:blur(20px); border:1px solid rgba(255,255,255,0.22); border-radius:24px; padding:40px 36px 36px; text-align:center; max-width:460px; width:100%; box-shadow:0 20px 60px rgba(0,0,0,0.45); }
        ...
        .role-chip { display:inline-block; background:#fff; color:#1565C0; font-size:10px; font-weight:800; padding:3px 14px; border-radius:20px; letter-spacing:1px; text-transform:uppercase; margin-bottom:24px; }
        .feature-list { background:rgba(255,255,255,0.10); border-radius:12px; padding:14px 18px; margin-bottom:24px; text-align:left; }
        ...
        .btn-masuk { display:block; width:100%; background:#fff; color:#1565C0; border:none; border-radius:12px; padding:13px; font-size:15px; font-weight:800; text-decoration:none; transition:all 0.2s; }
    ...
    <div class="hero">
        <div class="hero-card">
            <div class="logo-wrap">
                ...
                @else
                    <i class="bi bi-person-badge-fill logo-fallback"></i>
                @endif
            </div>
            <div class="hero-title">Portal Guru</div>
            <div class="hero-sub">Sistem Informasi Kesehatan</div>
            <div class="role-chip"><i class="bi bi-mortarboard-fill me-1"></i>Staff — Guru</div>
            ...
            <a href="{{ route('login.guru') }}" class="btn-masuk">
