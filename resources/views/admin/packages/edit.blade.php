...
<div class="card border-0 shadow-sm" style="border-radius:12px;">
    <div class="card-header fw-bold text-white py-3"
        ...
        <i class="bi bi-pencil-square me-2"></i>Edit: {{ $package->nama }}
    </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="harga"
                           ...
                           value="{{ old('harga', $package->harga) }}" min="0" step="500">
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label fw-semibold">Deskripsi</label>
                <input type="text" name="deskripsi" class="form-control"
                       value="{{ old('deskripsi', $package->deskripsi) }}">
            </div>
            <div class="mb-3">
                ...
                <div class="border rounded p-3" style="max-height:300px;overflow-y:auto;border-radius:8px!important;">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox"
                               ...
                               id="svc{{ $svc->id }}"
                               {{ in_array($svc->id, old('service_ids', $selectedServices)) ? 'checked':'' }}>
